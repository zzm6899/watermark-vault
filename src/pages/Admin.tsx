...
import { sampleAlbums, sampleBookings } from "@/lib/mock-data";
import { toast } from "sonner";

type Tab = "dashboard" | "albums" | "bookings" | "settings";
        ...
        {sampleAlbums.map((album) => (
          <div key={album.id} className="glass-panel rounded-xl p-4 flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs font-body text-muted-foreground">{album.photoCount} photos · {album.date}</p>
            </div>
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      ...
      <div className="space-y-6 max-w-lg">
        <div className="glass-panel rounded-xl p-6 space-y-4">
          ...
          <p className="text-xs font-body text-muted-foreground">Upload your logo to use as watermark on gallery images.</p>
        ...
        <div className="glass-panel rounded-xl p-6 space-y-4">
          <h3 className="font-display text-base text-foreground">Payment Integration</h3>
          <p className="text-xs font-body text-muted-foreground">Connect Stripe to accept payments for photo downloads.</p>

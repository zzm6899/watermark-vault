...
function priceBookingExtras(definitions = [], selections = []) {
  ...
  for (const extra of definitions) {
    if (!extra || typeof extra.id !== "string" || !extra.id || catalog.has(extra.id)
      ...
      || (extra.proofingPhotoSelection !== undefined && !["off", "optional", "required"].includes(extra.proofingPhotoSelection))
      || (extra.proofingInstructions !== undefined && (typeof extra.proofingInstructions !== "string" || extra.proofingInstructions.length > 300))
